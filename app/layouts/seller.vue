        ...
        <ion-buttons slot="start">
          <div class="flex items-center gap-2 pl-2">
            <div class="w-7 h-7 rounded-lg bg-farm-yellow flex items-center justify-center">
              <Icon name="heroicons:shopping-bag-solid" class="w-4 h-4 text-farm-deep" />
            </div>
            <div>
              <p class="text-white font-bold text-sm leading-tight">Seller Center</p>
        ...
        <ion-buttons slot="end">
          <div class="flex items-center gap-2 pr-3">
            <button class="relative p-1.5 rounded-full hover:bg-white/10 transition-colors">
              ...
              <span class="absolute top-0.5 right-0.5 w-2 h-2 bg-farm-yellow rounded-full" />
            </button>
            <button
            ...
            >
              ...
              <span class="text-white text-sm font-medium max-w-[100px] truncate">{{ user?.full_name }}</span>
