  ...
  <PageContainer class="space-y-12 py-8 md:py-12">
    ...
    <section class="border border-farm-light p-6 md:p-8 flex flex-col sm:flex-row sm:items-center gap-6">
      ...
      <div class="flex-1 min-w-0">
        <p class="text-[10px] font-medium tracking-[0.18em] uppercase text-farm-dark/45 mb-1">Role</p>
        <p class="text-sm font-medium text-farm-dark capitalize">{{ user?.role ?? 'seller' }}</p>
      </div>
    </section>

    <section class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-farm-light border border-farm-light">
      <div class="bg-white p-6 md:p-8">
        <p class="text-[10px] font-medium tracking-[0.18em] uppercase text-farm-dark/45 mb-2">Revenue</p>
        <p class="text-2xl font-light text-farm-dark tabular-nums">
          ₱{{ (metrics?.totalRevenue ?? 0).toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}
        </p>
      </div>
      <div class="bg-white p-6 md:p-8">
        <p class="text-[10px] font-medium tracking-[0.18em] uppercase text-farm-dark/45 mb-2">Orders</p>
        <p class="text-2xl font-light text-farm-dark tabular-nums">
    ...
    <section class="border border-farm-light divide-y divide-farm-light">
      <div class="flex items-center justify-between px-5 py-4 hover:bg-farm-light/30 transition-colors">
        <div class="flex items-center gap-3 min-w-0">
          <Icon name="heroicons:shopping-bag" class="w-5 h-5 text-farm-deep stroke-[1.5] flex-shrink-0" />
          <div class="min-w-0">
            <p class="text-sm font-medium text-farm-dark">Shop profile</p>
            <p class="text-xs text-farm-dark/45 truncate">Name and farm address</p>
          </div>
        </div>
      ...
      <div class="flex items-center justify-between px-5 py-4 hover:bg-farm-light/30 transition-colors">
        <div class="flex items-center gap-3 min-w-0">
          ...
          <div class="min-w-0">
            <p class="text-sm font-medium text-farm-dark">Account settings</p>
            <p class="text-xs text-farm-dark/45 truncate">Password and notifications</p>
          </div>
        </div>
        <Icon name="heroicons:chevron-right" class="w-4 h-4 text-farm-dark/30 flex-shrink-0" />
      </div>
      <div class="flex items-center justify-between px-5 py-4 hover:bg-farm-light/30 transition-colors">
        <div class="flex items-center gap-3 min-w-0">
          ...
          <div class="min-w-0">
            <p class="text-sm font-medium text-farm-dark">Help & support</p>
            <p class="text-xs text-farm-dark/45 truncate">FAQ and contact</p>
          </div>
        </div>
        <Icon name="heroicons:chevron-right" class="w-4 h-4 text-farm-dark/30 flex-shrink-0" />
      </div>
