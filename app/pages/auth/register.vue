<template>
  <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
    ...
    <aside class="hidden lg:flex flex-col justify-between items-center text-center relative text-white p-8 md:p-12 overflow-hidden">
      <!-- Background Matrix -->
      <img src="https://images.unsplash.com/photo-1533900298318-6b8da08a523e?auto=format&fit=crop&w=1200&q=80" alt="Fresh Farm Produce" class="absolute inset-0 w-full h-full object-cover opacity-80" />
